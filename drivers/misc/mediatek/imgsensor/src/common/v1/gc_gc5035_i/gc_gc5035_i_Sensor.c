...
#define gc5035_vendor_id  0x02 //0x2 for truly
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC_GC5035_I_SENSOR_ID,
...
static int gc5035_vendor_id_read(int addr)
{
    ...
    pr_no_info("GC_GC5035_I  read vendor id , form 0x%x  is: 0x%x\n", addr,flag);
	return flag;
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    if(flag != gc5035_vendor_id){
       pr_no_info("GC_GC5035_I  match vendor id fail, reead vendor id is: 0x%x,expect vendor id is 0x%x \n", flag,gc5035_vendor_id);
