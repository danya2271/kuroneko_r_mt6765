...
#define LOG_1 cam_pr_no_debug("OV2680,MIPI 1LANE\n")
#define LOG_2 cam_pr_no_debug("prv/vdo 1600*1200@30fps,600Mbps/lane\n")
/***************************   Modify end    *******************************/
...
{
	cam_pr_no_debug("dummyline = %d, dummypixels = %d\n",
...
static void set_shutter(kal_uint16 shutter)
{
	...
	/* cam_pr_no_debug("frame_length = %d ", frame_length); */
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (gain < BASEGAIN || gain >= 16 * BASEGAIN) {
		cam_pr_no_debug("Error gain setting");
...
{
	cam_pr_no_debug("Warining:Do not supportIHDR, Return. le:0x%x, se:0x%x, gain:0x%x\n",
		le, se, gain);
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	case IMAGE_HV_MIRROR:
		...
		break;
	default:
		cam_pr_no_debug("Error image_mirror setting\n");
	}
