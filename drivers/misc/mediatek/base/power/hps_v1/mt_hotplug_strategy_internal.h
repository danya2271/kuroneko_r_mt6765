 ...
 * LOG
 */
#define hps_err(fmt, args...)		pr_no_notice("[HPS] " fmt, ##args)
#define hps_warn(fmt, args...)		pr_no_notice("[HPS] " fmt, ##args)

#if EN_LOG_NOTICE
#define hps_notice(fmt, args...)	pr_no_notice("[HPS] " fmt, ##args)
#else
#define hps_notice(fmt, args...)	pr_no_debug("[HPS] " fmt, ##args)
#endif

#if EN_LOG_INFO
#define hps_info(fmt, args...)		pr_no_info("[HPS] " fmt, ##args)
#else
#define hps_info(fmt, args...)		pr_no_debug("[HPS] " fmt, ##args)
#endif

#if EN_LOG_DEBUG
#define hps_debug(fmt, args...)		pr_no_info("[HPS] " fmt, ##args)
#else
