 ...
 * LOG
 */
#define hps_emerg(fmt, args...)             pr_no_notice("[HPS] " fmt, ##args)
#define hps_alert(fmt, args...)             pr_no_notice("[HPS] " fmt, ##args)
#define hps_crit(fmt, args...)              pr_no_notice("[HPS] " fmt, ##args)
#define hps_error(fmt, args...)             pr_no_notice("[HPS] " fmt, ##args)
#define hps_warn(fmt, args...)              pr_no_notice("[HPS] " fmt, ##args)
#define hps_notice(fmt, args...)            pr_no_notice("[HPS] " fmt, ##args)
#define hps_info(fmt, args...)              pr_no_info("[HPS] " fmt, ##args)
#define hps_debug(fmt, args...)             pr_no_debug("[HPS] " fmt, ##args)
