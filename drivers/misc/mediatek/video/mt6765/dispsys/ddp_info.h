...
#ifndef TOTAL_REAL_OVL_LAYER_NUM
...
int ufmt_disable_X_channel(enum UNIFIED_COLOR_FMT src_fmt, enum UNIFIED_COLOR_FMT *dst_fmt, int *const_bld);
...
struct DDP_MODULE_DRIVER {
	...
	int (*ioctl)(enum DISP_MODULE_ENUM module, void *handle, enum DDP_IOCTL_NAME ioctl_cmd, void *params);
	int (*enable_irq)(enum DISP_MODULE_ENUM module, void *handle, enum DDP_IRQ_LEVEL irq_level);
	int (*connect)(enum DISP_MODULE_ENUM module, enum DISP_MODULE_ENUM prev, enum DISP_MODULE_ENUM next, int connect, void *handle);
...
void ddp_set_module_driver(enum DISP_MODULE_ENUM module, struct DDP_MODULE_DRIVER *drv);
