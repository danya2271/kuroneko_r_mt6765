...
#define __DISP_SYSTRACE_BEGIN(pid, fmt, args...) do {} while (0)

#define DISP_SYSTRACE_BEGIN(fmt, args...) do {} while (0)

#define DISP_SYSTRACE_END() do {} while (0)

#define _DISP_TRACE_CNT(tgid, cnt, fmt, args...) do {} while (0)

#define DISP_TRACE_CNT(cnt, fmt, args...) do {} while (0)
