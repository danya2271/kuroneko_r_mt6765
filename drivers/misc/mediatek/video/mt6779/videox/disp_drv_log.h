...
#define DISP_ONESHOT_DUMP(string, args...)				\
	pr_debug("mtk-disp/dump: " string, ##args)
...
#define disp_aee_print(string, args...) DISP_PR_ERR(string, ##args)
#define disp_aee_db_print(string, args...) DISP_PR_ERR(string, ##args)
