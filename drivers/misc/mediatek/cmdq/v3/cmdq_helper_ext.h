...
#define CMDQ_VERBOSE(string, args...) pr_debug("[CMDQ] " string, ##args)

#define CMDQ_ERR(string, args...) pr_err("[CMDQ] " string, ##args)
...
#define CMDQ_AEE(tag, string, args...) pr_err("[CMDQ_AEE][%s] " string, tag, ##args)
