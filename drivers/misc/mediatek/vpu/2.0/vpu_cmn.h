...
#endif
#define LOG_INF(format, args...)    pr_no_info(VPU_TAG " " format, ##args)
#define LOG_WRN(format, args...)    pr_no_info(VPU_TAG "[warn] " format, ##args)
#define LOG_ERR(format, args...)    pr_no_info(VPU_TAG "[error] " format, ##args)

#define PRINT_LINE() pr_no_info(VPU_TAG " %s (%s:%d)\n", \
