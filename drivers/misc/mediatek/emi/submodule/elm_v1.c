...
static irqreturn_t elm_isr(int irq, void *dev_id)
{
	...
	pr_no_info("[ELM] latency violation\n");
...
void elm_init(struct platform_driver *emi_ctrl, struct platform_device *pdev)
{
	...
	if (ret)
		pr_no_info("[ELM] fail to create elm_ctrl\n");
}
