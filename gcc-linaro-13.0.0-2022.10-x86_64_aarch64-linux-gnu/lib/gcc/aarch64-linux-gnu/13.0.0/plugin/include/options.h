...
enum opt_code
{
  ...
  OPT_mbionic = 1802,                        /* -mbionic */
  OPT_mbranch_protection_ = 1803,            /* -mbranch-protection= */
  OPT_mcmodel_ = 1804,                       /* -mcmodel= */
  OPT_mcpu_ = 1805,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1806,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1807,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1808,             /* -mgeneral-regs-only */
  OPT_mglibc = 1809,                         /* -mglibc */
  ...
  OPT_pie = 1853,                            /* -pie */
  OPT_pipe = 1854,                           /* -pipe */
  OPT_posix = 1855,                          /* -posix */
  OPT_print_file_name_ = 1856,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1857,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1858,          /* -print-multi-directory */
  OPT_print_multi_lib = 1859,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1860,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1861,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1862,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1863,               /* -print-prog-name= */
  OPT_print_search_dirs = 1864,              /* -print-search-dirs */
  OPT_print_sysroot = 1865,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1866,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1867,                    /* -print-value */
  OPT_profile = 1868,                        /* -profile */
  OPT_pthread = 1869,                        /* -pthread */
  OPT_quiet = 1870,                          /* -quiet */
  OPT_r = 1871,                              /* -r */
  OPT_rdynamic = 1872,                       /* -rdynamic */
  OPT_remap = 1873,                          /* -remap */
  OPT_reverse_sort = 1874,                   /* -reverse-sort */
  OPT_s = 1875,                              /* -s */
  OPT_save_temps = 1876,                     /* -save-temps */
  OPT_save_temps_ = 1877,                    /* -save-temps= */
  OPT_shared = 1878,                         /* -shared */
  OPT_shared_libgcc = 1879,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1880,               /* -shared-libphobos */
  OPT_size_sort = 1881,                      /* -size-sort */
  /* OPT_specs = 1882, */                    /* -specs */
  OPT_specs_ = 1883,                         /* -specs= */
  OPT_static = 1884,                         /* -static */
  OPT_static_libasan = 1885,                 /* -static-libasan */
  OPT_static_libgcc = 1886,                  /* -static-libgcc */
  OPT_static_libgfortran = 1887,             /* -static-libgfortran */
  OPT_static_libgo = 1888,                   /* -static-libgo */
  OPT_static_libhwasan = 1889,               /* -static-libhwasan */
  OPT_static_liblsan = 1890,                 /* -static-liblsan */
  OPT_static_libmpx = 1891,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1892,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1893,               /* -static-libphobos */
  OPT_static_libquadmath = 1894,             /* -static-libquadmath */
